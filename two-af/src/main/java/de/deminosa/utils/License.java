...
public class License {
	...
	private String securityKey = "U4uCK9ff8dEGDHedtX6aAWTtVwRtCjzZspum";
	private String pluginName;
	private boolean debug = false;

	public License(String licenseKey, String validationServer, String pluginName) {
	...
	private String requestServer(String v1, String v2) throws IOException {
		URL url = new URL(validationServer + "?v1=" + v1 + "&v2=" + v2 + "&pl=" + pluginName);
